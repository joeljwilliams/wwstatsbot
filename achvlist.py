ACHV = [{"name": "Welcome to Hell", "desc": "Play a game"},
        ...
        {"name": "Firefighter", "desc": "As the guardian angel, clean three houses of kerosene."},
        {"name": "Helpful Paranoia", "desc": "As the hunter, shoot two attackers!"},
        {"name": "S-Tier Hunter", "desc": "As the hunter, take down a wolf and a cultist in the same night!"},
        {"name": "Triple Kill", "desc": "As a serial killer or wolf, have at least three people die by your hand in the same night!"},
        {"name": "Resist the Beast", "desc": "As a trio of wild child, traitor, and cursed, all remain human and win the game with the village."},
        {"name": "At least you tried...", "desc": "As the guardian angel, save someone at night only to watch them die to the chemist's poison."},
        {"name": "Lucky Night", "desc": "Survive the chemist's visit and enjoy the harlot's visit in the same night!"},
        {"name": "In the Middle of the Trouble", "desc": "As the guardian angel, save a werewolf from an attack and survive!"},
        {"name": "Am I hallucinating?!", "desc": "As the fool, see a role which the seer can never see"},
        {"name": "Going Down with my Beer", "desc": "As a villager, die by visiting the bar the night it is set on fire."},
        {"name": "Alcoholics Anonymous", "desc": "Be one of 3 or more drunks at the end of the game."},
        {"name": "Liquid Business", "desc": "As the barkeep, have your bar visited by 3 or more villagers in one night."},
        {"name": "Traffic Control", "desc": "As the chef, find out that a person was visited by 3 people in one night!"},
        {"name": "Definitely Dead", "desc": "As the chef, track a person who is murdered that night."},
        {"name": "Going Out Of Business", "desc": "As the barkeep in a game of 10 players or more, have no visitors in your bar for 3 nights in a row!"},
        {"name": "Food Waste", "desc": "As the chef, track 3 or more different people who did not leave their house and did not have visitors."}]
