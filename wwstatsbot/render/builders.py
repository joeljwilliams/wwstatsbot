...
async def build_kills_msg(user_id, name):
    ...
    msg = t.KILLS_HEADER.format(user_id=user_id, name=name, badge=badges.of(user_id))
    for k in kills.data:
...
async def build_killed_by_msg(user_id, name):
    ...
    msg = t.KILLED_BY_HEADER.format(user_id=user_id, name=name, badge=badges.of(user_id))
...
async def build_deaths_msg(user_id, name):
    ...
    msg = t.DEATHS_HEADER.format(user_id=user_id, name=name, badge=badges.of(user_id))
...
async def build_stats_msg(user_id, name, by_id=False):
    ...
    if not stats:
        ...
        return template.format(user_id=user_id, name=name, username=username, badge=badges.of(user_id))
