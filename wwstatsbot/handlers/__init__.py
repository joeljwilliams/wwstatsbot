...
Split out of main.py — which holds only the registration table (build_application) and
the process lifecycle — and the first slice taken out of it, before the rest of the bot
followed into wwstatsbot/. Each module here owns one family of user-facing commands plus
the private helpers only that family uses.
